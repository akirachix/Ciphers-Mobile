...
class DevelopmentalMilestonesScreenFour : BaseMilestoneScreen() {
    override val category: String = "Cognitive"
    override val isLastScreen: Boolean = false

    override fun moveToNextScreen() {
        val intent = Intent(this, DevelopmentalMilestonesScreenSix::class.java).apply {
